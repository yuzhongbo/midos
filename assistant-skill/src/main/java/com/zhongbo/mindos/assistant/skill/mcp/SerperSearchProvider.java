...
final class SerperSearchProvider implements SearchToolAdapter {
    ...
    public Optional<SearchToolBinding> adapt(SearchSourceConfig source, Map<String, String> headers) {
        ...
        McpToolDefinition tool = new McpToolDefinition(
                ...
                url,
                "webSearch",
                "Serper latest web/news search",
                mergedHeaders
        );
        return Optional.of(new SearchToolBinding(tool, new SerperSearchRestClient(), SearchRequestStyle.POST_JSON, "Serper", source.resolvedNewsUrl(), ""));
    }
